package com.yhxc.utils.sms;

import com.yhxc.common.Constant;
import com.yhxc.utils.Const;
...
public class SmsUtil {
    ...
    private static Properties pros = getPprVue("setting/sms.properties");

    public static void main(String[] args) {

        //sendSms2("15893105954", "您的验证码是：1111。请不要把验证码泄露给其他人。");
    ...
    public static String sendSms1(String mobile, String code) {
        ...
        String strSMS1 = "";//Tools.readTxtFile(Constant.SMS1, session);            //读取短信1配置
        if (null != strSMS1 && !"".equals(strSMS1)) {
            String strS1[] = strSMS1.split(",");
            if (strS1.length == 2) {
                account = strS1[0];
                password = strS1[1];
            }
     ...
     * @param code   短信内容
     */
    public static Boolean sendSms2(String mobile, String code, HttpSession session) {
        HttpClient client = new HttpClient();
        PostMethod method = new PostMethod(Url);
        ...
        String account = "", password = "";
        String strSMS2 = Tools.readTxtFile(Const.SMS2, session);            //读取短信2配置
        if (null != strSMS2 && !"".equals(strSMS2)) {
            String strS2[] = strSMS2.split(",");
            if (strS2.length == 2) {
                account = strS2[0];
                password = strS2[1];
            }
        ...
        try {
            ...
            String msg = root.elementText("msg");
            String smsid = root.elementText("smsid");
            //logger.error("【发送短信】，接口返回编码："+code +"，说明："+msg);
     ...
     * @param code   短信内容
     */
    public static Boolean sendSms3(String mobile, String code  ) {
        HttpClient client = new HttpClient();
        PostMethod method = new PostMethod(Url);
        ...
        String account = "C34401323", password = "49120f82043d8871070a4c1974417360";
