...
import com.yhxc.config.filter.KickoutSessionFilter;
import com.yhxc.realm.MyRealm;
...
public class ShiroConfig {
    ...
    public ShiroFilterFactoryBean shiroFilterFactoryBean(
        ...
        // 配置不会被拦截的链接 顺序 shiroFilterFactoryBean.setSuccessUrl("/index.html");判断
        filterChainDefinitionMap.put("/login/login", "anon,kickout");
        filterChainDefinitionMap.put("/login/appLogin", "anon,kickout");
        filterChainDefinitionMap.put("/app/*/*", "anon,kickout");
        filterChainDefinitionMap.put("/kickout", "anon");
        filterChainDefinitionMap.put("/login/logout", "anon,kickout");

        filterChainDefinitionMap.put("/user/saveOrUpdate", "anon,kickout");

//        忘记密码放行操作
        filterChainDefinitionMap.put("/user/forgetPassword", "anon,kickout");
        filterChainDefinitionMap.put("/user/changePassword", "anon,kickout");
